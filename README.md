...
| **API Center portal** (catalog) | `https://<api-center-name>.portal.<region>.azure-apicenter.ms` | Human-browsable catalog where developers can discover registered MCP servers, view metadata, and find endpoint URLs. |
